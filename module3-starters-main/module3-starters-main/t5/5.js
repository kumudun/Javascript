...
// Use a for-loop to create and append <article> elements
for (let i = 0; i < picArray.length; i++) {
    // Create the <article> element
    let article = document.createElement("article");
    article.classList.add("card");

    // Create the <h2> element and set its content
    ...
    image.src = picArray[i].mediumImage;
    image.alt = picArray[i].title;

    // Create the <figcaption> element and set its content
    ...
    // Append the <h2>, <figure>, and <p> to the <article>
